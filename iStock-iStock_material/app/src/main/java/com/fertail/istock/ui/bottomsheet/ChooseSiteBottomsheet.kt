...
import com.fertail.istock.ui.verification.adapter.SiteMasterAdapter
import com.fertail.istock.view_model.GetStatusViewModel
...
class ChooseSiteBottomsheet(
    ...
    private val getNounViewModel: GetStatusViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        binding.idTitle.text = "Choose Status"
    ...
    private fun initRecyclerView() {
        ...
        val adapter = SiteMasterAdapter(param)
