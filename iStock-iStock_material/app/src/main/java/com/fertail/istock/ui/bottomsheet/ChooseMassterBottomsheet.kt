...
import com.fertail.istock.ui.verification.adapter.PagingMasterAdapter
...
@AndroidEntryPoint
class ChooseMassterBottomsheet(
    ...
    private val getNounViewModel: GetAllMasterViewModel by viewModels()
    ...
    private fun initRecyclerView() {
        ...
        val adapter = PagingMasterAdapter(param)
